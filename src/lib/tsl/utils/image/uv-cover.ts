/**
 * CSS object-fit: cover equivalent for textures in TSL
 * Scales texture to cover entire plane while maintaining aspect ratio
 * @module tsl/utils/image/uv-cover
 */
...
/**
 * Calculate UV coordinates for cover-fit texture mapping
 ...
 */
export const coverTextureUv = Fn<
