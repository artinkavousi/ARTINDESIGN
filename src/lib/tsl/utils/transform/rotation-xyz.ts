/**
 * Full XYZ Euler rotation matrix for TSL
 * Creates a rotation matrix from Euler angles (X, Y, Z order)
 * @module tsl/utils/transform/rotation-xyz
 */

import { Fn, cos, sin, float, mat3, vec3, type ShaderNodeObject } from 'three/tsl'
import type { Node } from 'three/webgpu'

export const rotationXYZ = Fn<[ShaderNodeObject<Node>]>(([euler_immutable]) => {
