/**
 * Z-axis rotation matrix for TSL
 * Rotates a 3D position around the Z axis
 * @module tsl/utils/transform/rotate-z
 */

import { Fn, cos, float, mat3, sin, vec3 } from 'three/tsl'

export const rotateZ = Fn(([position_immutable, angle_immutable]) => {
